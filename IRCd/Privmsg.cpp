...
class Plugin_Privmsg : public IRC_Plugin
{
public:
	Plugin_Privmsg(shared_ptr<IRC_Server> ircd, void* handle)
	: IRC_Plugin(handle),
	m_ircd(ircd)
	{
		cout << "Privmsg Initialization" << endl;
...
{
	return new Plugin_Privmsg(ircd, handle);
}
